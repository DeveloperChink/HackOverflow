    ...
    <div class="container-fluid">
        ...
        <div class="jumbotron">
            ...
            <div class="text-center mb-5 text-responsive" style="font-size: 24px; color: #2680C2;">
                transparency embraces accountability
            </div>
        </div>
        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-lg-5 bg-white shadow-sm mt-3 mr-3" style="border-radius: 20px;" >
                    <a href= "{{ url('/projects/proposed-mandaue-sports-center')}}">
                        ...
                        <div class="d-flex align-items-baseline">
                            <div class="mr-auto" style="color: #486581;font-size: 24px;">
                                Completion of Banilad Multi-Purpose Building
                            </div>
                            <div class="mr-1">
                            ...
                            <div>
                                ...
                                <span style="color:#9FB3C8;"> 20+</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-5 bg-white shadow-sm mt-3 mr-3" style="border-radius: 20px;" >
                    <a href= "{{ url('/projects/proposed-mandaue-sports-center')}}">
                        ...
                        <div class="d-flex align-items-baseline">
                            <div class="mr-auto" style="color: #486581;font-size: 24px;">
                                Acquisition of PPE's for Mandaue City Hospital
                            </div>
                            <div class="mr-1">
                                <i class="fa fa-smile-o" style="color:#9FB3C8;"></i>
                                <span style="color:#9FB3C8;"> 320+</span>
                            </div>
                            <div>
                                <i class="fa fa-frown-o" style="color:#9FB3C8;"></i>
                                <span style="color:#9FB3C8;"> 20+</span>
                ...
                <div class="col-lg-5 bg-white shadow-sm mt-3 mr-3" style="border-radius: 20px;" >
                    <a href= "{{ url('/projects/proposed-mandaue-sports-center')}}">
                        ...
                        <div class="d-flex align-items-baseline">
                            <div class="mr-auto" style="color: #486581;font-size: 24px;">
                                Purchase of Printers for Modular Learning
                            </div>
                            <div class="mr-1">
                                <i class="fa fa-smile-o" style="color:#9FB3C8;"></i>
                                <span style="color:#9FB3C8;"> 750+</span>
                            </div>
                            <div>
                                <i class="fa fa-frown-o" style="color:#9FB3C8;"></i>
                                <span style="color:#9FB3C8;"> 120+</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-baseline pb-2">
                            <svg width="12" height="16" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-5 bg-white shadow-sm mt-3 mr-3" style="border-radius: 20px;" >
                    <a href= "{{ url('/projects/proposed-mandaue-sports-center')}}">
                        ...
                        <div class="d-flex align-items-baseline">
                            <div class="mr-auto" style="color: #486581;font-size: 24px;">
                                Green Corridor Along Butuanon River Phase II
                            </div>
                            <div class="mr-1">
                                <i class="fa fa-smile-o" style="color:#9FB3C8;"></i>
                                <span style="color:#9FB3C8;"> 550+</span>
                            </div>
                            <div>
                                <i class="fa fa-frown-o" style="color:#9FB3C8;"></i>
                                <span style="color:#9FB3C8;"> 20+</span>
                ...
                <div class="col-lg-5 bg-white shadow-sm mt-3 mr-3" style="border-radius: 20px;" >
                    <a href= "{{ url('/projects/proposed-mandaue-sports-center')}}">
                        ...
                        <div class="d-flex align-items-baseline">
                            ...
                            <div class="mr-1">
                                <i class="fa fa-smile-o" style="color:#9FB3C8;"></i>
                                <span style="color:#9FB3C8;"> 321+</span>
                            </div>
                            <div>
                                <i class="fa fa-frown-o" style="color:#9FB3C8;"></i>
                                <span style="color:#9FB3C8;"> 70+</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-baseline pb-2">
                            <svg width="12" height="16" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
