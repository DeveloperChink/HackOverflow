                ...
                <div class="col-lg col-md-4 col-sm-6 col-6">
                    ...
                    <div class="row">
                        <div class="ml-auto d-flex align-items-center">
                            ...
                            <div class="ml-1" style="font-size: 16px; color: #9FB3C8;">September 21, 2019</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg col-md-4 col-sm-6 col-6">
                    ...
                    <div class="row">
                        <div class="ml-auto d-flex align-items-center">
                            ...
                            <div class="ml-1" style="font-size: 16px; color: #9FB3C8;">June 1, 2020</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg col-md-4 col-sm-6 col-6">
                    <div class="row">
                        <div class="ml-auto d-flex align-items-center">
                            ...
                            <div class="ml-1" style="font-size: 16px; color: #9FB3C8;">July 21, 2020</div>
                        </div>
                    </div>
                </div>
            </div>
